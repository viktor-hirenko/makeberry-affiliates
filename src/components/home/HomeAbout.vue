 ...
 * Карточка идентична info-блокам по габаритам, но PNG декоративного бейджа
 * заполняет её через object-fit: contain — собственные прозрачные поля
 * внутри ассета дают визуальный отступ как в Figma.
 * ============================================================ */
